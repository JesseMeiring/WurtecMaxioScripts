...
let SentinelField = getComponentField("2534387");
...
submitbtn.click(function () {
  ...
  if (!validMainQty(SentinelField.val())) {
    setCustomFieldError(SentinelField, qtyZeroEMessage);
    errorsCheck = true;
  }
  if (errorsCheck) {
